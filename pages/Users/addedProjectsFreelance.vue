...
var projectId = ref()
var freelanceName = ref()
var freelanceBudget = ref()
var freelanceTime = ref()
var skills = ref()
var description = ref() 
var projectInfo = ref()
function getData(){
   if(process.client){
    ...
    axios.post('http://127.0.0.1:8000/api/user/getFreelanceProjects',info.value)
    .then(res=>{
...
function insertData(info){
  ...
  freelanceName.value = info.freelanceName
  freelanceBudget.value = info.freelanceBudget
  description.value = info.description
  freelanceTime.value = info.freelanceTime
...
console.log(updatedData.value);
  axios.post('http://127.0.0.1:8000/api/user/updateAddedProjectFreelance',updatedData.value)
  .then(res=>{
    dialog.value = false
...
function removeProject(id){
  if(process.client){
    ...
    axios.post('http://127.0.0.1:8000/api/user/removeFreelanceProject',Info.value)
    .then(res=>{
